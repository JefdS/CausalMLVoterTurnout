...
selected.variables <- c("voted","voted.president","race","race.binary","gender","age","sexual.orientation",
                        "religiousness","religion","rural.urban","rural.urban.binary","income","education","employment","marital.status","party.identification",
...
Z <- c("gender","age","sexual.orientation") # confounders
W <-  c("education","employment","income","marital.status","rural.urban.binary","religiousness",
...
### MEASURES USED FOR TABLE 2###
voter.turnout.meas_individual.IE
write_xlsx(voter.turnout.meas_individual.IE,"Individual indirect effects.xlsx")
...
W <-  c("education","employment","income","marital.status","rural.urban.binary","religiousness",
        "political.engagement.involvement.community","political.engagement.involvement.political",
        "political.engagement.mobilization","political.engagement.discussion","LR.attitudes",
        "democratic.norms.1","democratic.norms.2","trust.politics","government.role.social",
        "government.role.security","engagement.campaigns") # mediators
...
autoplot(tvd.voter.turnout_significant.W, 
         decompose = "xspec",
         dataset = "Voter Turnout Data") +
...
W <-  c("education","employment","income","marital.status","rural.urban.binary","religiousness",
        ...
        "political.engagement.mobilization","political.engagement.discussion","LR.attitudes",
        "democratic.norms.1","democratic.norms.2","trust.politics","government.role.social",
        "government.role.security","engagement.campaigns","closeness.election") # mediators
W.label <- c("Education","Employment","Income","Marital status","Rural/urban","Religiousness","Political engagement - community involvement",
             "Political engagement - political involvement","Political engagement - mobilization","Political engagement - discussion",
             "Left-right attitudes","Democratic norms - media","Democratic norms - government","Trust in politics","Government role - social",
             "Government role - security","Engagement campaigns","Closeness of election")
...
write_xlsx(tvd.voter.turnout.significant.W,"tvd.voter.turnout.significant.W 20250624.xlsx")

voter.turnout.meas_split.significant.W$mediator <- factor(voter.turnout.meas_split.significant.W$mediator, levels=c("Education","Employment","Income","Marital status","Rural/urban","Religiousness","Political engagement - community involvement",
                                                                                                                    "Political engagement - political involvement","Political engagement - mobilization","Political engagement - discussion",
                                                                                                                    "Left-right attitudes","Democratic norms - media","Democratic norms - government","Trust in politics","Government role - social",
                                                                                                                    "Government role - security","Engagement campaigns","Closeness of election","All"))
tvd.voter.turnout.significant.W$mediator <- factor(voter.turnout.meas_split.significant.W$mediator, levels=c("Education","Employment","Income","Marital status","Rural/urban","Religiousness","Political engagement - community involvement",
                                                                                                             "Political engagement - political involvement","Political engagement - mobilization","Political engagement - discussion",
                                                                                                             "Left-right attitudes","Democratic norms - media","Democratic norms - government","Trust in politics","Government role - social",
                                                                                                             "Government role - security","Engagement campaigns","Closeness of election","All"))
...
ggplot(voter.turnout.data.scope, aes(x = age, fill = race.binary)) +
  ...
  scale_fill_manual(values = c("0" =  "#BE3D2A", "1" ="#F5C45E"),
...
#### RUN MODEL - Set X, Y, Z and add income --> significant standalone IE ####
W <- c("education","employment","income","marital.status") # mediators
...
autoplot(tvd.voter.turnout_income, decompose = "xspec",dataset = "Voter Turnout Data - add marital status")

#### RUN MODEL - Set X, Y, Z and add rural.urban --> significant standalone IE ####
W <- c("education","employment","income","marital.status","rural.urban.binary") # mediators
...
W <- c("education","employment","income","marital.status","rural.urban.binary","religiousness") # mediators
